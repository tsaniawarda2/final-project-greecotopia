      ...
      <div className="tanam-pohon container-fluid p-0">
        ...
        <section className="content-tp-2">
          <div className="row row-tp-2">
            <div className="col-lg-8">
              ...
              <ul>
                <li>Mendaftar dan mengisi data diri.</li>
                <li>Datang ke tempat Tanam Pohon yang kamu pilih.</li>
                <li>Dokumentasikan kegiatan untuk bukti mengikuti kegiatan kemudian unggah ke formulir yang di sediakan.</li>
                <li>Informasi tambahan:
                    Tanam Pohon ini merupakan program berkala yang bertujuan untuk menahan laju suhu iklim global.</li>
              </ul>
            </div>
        ...
        <section className="content-tp-3">
          <div className="row text-section-3">
            <div className="col-lg-9 text-header-tp-3">
        ...
        <section className="content-tp-4">
          <div className="row text-section-4">
            <div className="col-lg-9 text-header-tp-4">
              <h1>Dokumentasi Tanam Pohon</h1>
            </div>
            <div className="col-lg-3">
              <button className="btn-tp-4">Lebih Banyak</button>
            </div>
          </div>
            <div className="row dokumetasi-content">
              <div className="col-lg-6 doc-column-1">
              ...
              <div className="col-lg-6 doc-column-2">
              <img src="https://images.unsplash.com/photo-1598335624134-5bceb5de202d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"></img>
              <img src="https://images.unsplash.com/photo-1598335624134-5bceb5de202d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"></img>
              <img src="https://images.unsplash.com/photo-1598335624134-5bceb5de202d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"></img>
              </div>
