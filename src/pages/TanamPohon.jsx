      ...
      <div className="tanam-pohon container-fluid p-0">
        <section className="header-tp">
          <div className="content-header-tp">
            ...
            <p className="text-header-tp">
              Greenpeace Indonesia menyediakan ruang bagi kamu yang ingin
              kembali menguhijaukan bumi kita dengan cara menanam pohon. Ayo
              berkontribusi untuk membuat bumi menjadi lebih baik!
            </p>
            <button
              className="btn-tanam-pohon"
              onClick={() => history.push("/alltanampohon")}
            >
              MULAI MENANAM POHON
            </button>
          </div>
          ...
          <div className="row row-tp-2">
            <div className="col-lg-7 tp-2-text">
              ...
              <ul>
                <li>
                  {" "}
                  <i className="fas fa-check-circle"></i> Mendaftar dan mengisi
                  data diri.
                </li>
                <li>
                  {" "}
                  <i className="fas fa-check-circle"></i> Datang ke tempat Tanam
                  Pohon yang kamu pilih.
                </li>
                <li>
                  {" "}
                  <i className="fas fa-check-circle"></i> Dokumentasikan
                  kegiatan untuk bukti mengikuti kegiatan kemudian unggah ke
                  formulir yang di sediakan.
                </li>
                <br></br>
                <p>
                  {" "}
                  Informasi tambahan:<br></br>
                  Tanam Pohon ini merupakan program berkala yang bertujuan untuk
                  menahan laju suhu iklim global.
                </p>
              </ul>
            </div>
        ...
        <section className="content-tp-4">
          <div className="row text-section-4">
            ...
            <div className="col-lg-2 col-md-3 btn-header-tp-4">
              <button
                className="btn-tp-3"
                onClick={() => history.push("/documentations")}
              >
                Lebih Banyak
              </button>
            </div>
          ...
          <div className="dokumetasi-content">
            ...
            <div className="row under-slideshow">
              <div className="pict-doc col-lg-2 col-md-5 ">
                <img
                  src="https://images.unsplash.com/photo-1535978115060-d01ae6702684?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
                  alt=""
                />
              </div>
              <div className="pict-doc col-lg-2 col-md-5">
                <img
                  src="https://images.unsplash.com/photo-1611843467160-25afb8df1074?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
                  alt=""
                />
              </div>
              <div className="pict-doc col-lg-2 col-md-5">
                <img
                  src="https://images.unsplash.com/photo-1622383563227-04401ab4e5ea?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"
                  alt=""
                />
              </div>
              <div className="pict-doc col-lg-2 col-md-5">
                <img
                  src="https://images.unsplash.com/photo-1631401551847-78450ef649d8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"
                  alt=""
                />
              </div>
            </div>
