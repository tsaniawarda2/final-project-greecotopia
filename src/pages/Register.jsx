          ...
          <div id="form">
            ...
            <form>
              ...
              <div className="mb-4">
                ...
                <input type="text" className="form-control" id="formRegister" value={form?.fullname}  onChange={e => setForm({ ...form, fullname: e.target?.value })}/>
              </div>
              {/* Email */}
              <div className="mb-4">
                ...
                <input type="text" className="form-control" id="formRegister" value={form?.email}  onChange={e => setForm({ ...form, email: e.target?.value })}/>
              </div>
              {/* Username */}
              <div className="mb-4">
                ...
                <input type="text" className="form-control" id="formRegister" value={form?.username}  onChange={e => setForm({ ...form, username: e.target?.value })}/>
              </div>
              {/* Password */}
